...
import { Search, UserCircle, Calendar, Scale, Coins, SortAsc, SortDesc } from 'lucide-react';
  ...
  return (
    <>
      {/*<Container size="xl" py="xl">*/}
        <Title order={1} mb="lg">Sales Records</Title>
            ...
            >
              <Flex direction="column" gap="sm">
                <Group justify="space-between">
                  ...
                  <Text fw={700} c="dimmed" size="sm">#{sale.id}</Text>
                </Group>
                ...
                <Group justify="space-between">
                  ...
                  <Text fw={700} size="lg" c="blue">${sale.totalPrice.toFixed(2)}</Text>
                </Group>
