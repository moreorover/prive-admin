...
export const HairSalePickerModal = ({
	context,
	id,
	innerProps,
}: TypedContextModalProps<"hairSalePicker">) => {
	const [selectedRows, setSelectedRows] = useState<string[]>([]);
	const [selectedRow, setSelectedRow] = useState<string>();

	const hairOrderOptions = trpc.hairSales.getHairSaleOptions.useQuery({
		hairSaleId: innerProps.hairSaleId,
	});
